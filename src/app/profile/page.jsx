...
export default function ProfilePage() {
  ...
  const { data: postsData, isLoading: postsLoading } = useQuery({
    ...
    queryFn: () => postsApi.getPostsByUserId(user?.userId),
    enabled: !!user?.userId && activeTab === "posts",
  });
          ...
          <div className="bg-[#0d1d2c] border border-[#343536] rounded-lg w-full max-w-md p-6">
            ...
            <form onSubmit={handleUpdateUser}>
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isUpdating || !editName.trim() || editName === user?.name}
